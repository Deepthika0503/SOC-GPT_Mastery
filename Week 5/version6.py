...
# Norm is applied before transformation - this is called pre-norm formulation
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.proj(out) # projection is the linear transformation of the outcome of this layer
        return out
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.blocks = nn.Sequential(
            ...
            Block(n_embd, n_head=4),
            nn.LayerNorm(n_embd),
        ) # Only this does not work good because deep neural networks suffer from opimization issues
